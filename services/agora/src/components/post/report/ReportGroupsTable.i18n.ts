...
> = {
  ...
  fa: {
    title: "گروه‌های نظر",
    subtitle: "گروه‌ها بر اساس رفتار رأی‌گیری تشکیل می‌شوند، بدون توجه به زبان. سپس یک مدل هوش مصنوعی گزاره‌های هر گروه را می‌خواند تا نام و خلاصه‌ای تولید کند.",
    subtitleNoAi: "گروه‌ها بر اساس رفتار رأی‌گیری تشکیل می‌شوند، بدون توجه به زبان.",
    label: "گروه",
    participants: "شرکت‌کنندگان",
    aiSummary: "خلاصه",
    notEnoughGroups: "هنوز مشارکت کافی برای تشکیل گروه‌های نظر متمایز وجود ندارد.",
    noSummary: "خلاصه هنوز در دسترس نیست.",
    noGroup: "بدون گروه",
    imbalanceNotice: "اکثر شرکت‌کنندگان در یک گروه هستند زیرا تقریباً یکسان رأی دادند.",
    noGroupExplanation: "شرکت‌کنندگانی که به کمتر از {minVotes} گزاره رأی دادند",
  },
};
