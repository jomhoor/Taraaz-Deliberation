...
> = {
  ...
  fa: {
    ...
    agreementsLong: "کدام گزاره‌ها توسط همه گروه‌ها تأیید شده‌اند؟",
    disagreementsLong: "کدام گزاره‌ها توسط همه گروه‌ها رد شده‌اند؟",
    divisiveLong: "چه چیزی شرکت‌کنندگان را در گروه‌های مختلف از هم جدا می‌کند؟",
    agreementsSubtitle: "اجماع میان‌گروهی، نه اکثریت ساده. تنها معنادارترین موارد از نظر آماری نمایش داده می‌شوند.",
    disagreementsSubtitle: "اجماع میان‌گروهی، نه اکثریت ساده. تنها معنادارترین موارد از نظر آماری نمایش داده می‌شوند.",
    divisiveSubtitle: "گزاره‌هایی که گروه‌های نظر را در مقابل هم قرار می‌دهند. تنها معنادارترین موارد از نظر آماری نمایش داده می‌شوند.",
    noAgreementsMessage: "هنوز اجماعی شکل نگرفته است.",
    noDisagreementsMessage: "هنوز اجماعی شکل نگرفته است.",
    noDivisiveMessage: "هنوز گزاره‌های بحث‌برانگیز معناداری یافت نشده است.",
  },
};
