...
> = {
  ...
  fa: {
    groupsTitle: "گروه‌های نظر",
    groupsSubtitle: "گروه‌ها بر اساس رفتار رأی‌گیری شکل می‌گیرند، صرف‌نظر از زبان. سپس یک مدل هوش مصنوعی گزاره‌های هر گروه را می‌خواند تا نام و خلاصه‌ای تولید کند.",
    groupsSubtitleNoAi: "گروه‌ها بر اساس رفتار رأی‌گیری شکل می‌گیرند، صرف‌نظر از زبان.",
    notEnoughGroupsMessage: "گروه‌های کافی برای نمایش وجود ندارد.",
    imbalanceNotice: "اکثر شرکت‌کنندگان در یک گروه هستند زیرا تقریباً یکسان رأی داده‌اند.",
  },
};
